...
import bepal.eosio.crypto.util.BitUtils;
import bepal.eosio.util.RefValue;
...
public class EosEcUtil {
    ...
    public static final String EOS_Sign = "SIG_K1_";
    ...
    public static byte[] parseKeyBase58(String base58Key, RefValue<CurveParam> curveParamRef, RefValue<Long> checksumRef) {
        ...
        if (base58Key.startsWith(EOS_PREFIX)) {
            ...
            } else if (base58Key.startsWith(PREFIX_R1, EOS_PREFIX.length())) {
